...
alias updateall="sudo pacman -Syu; yay -Syu"
alias jump="z"
alias mkzip="zip -r"
alias gacp="git add * ; git commit --all -m '.' ; git push --all"
alias gclone="git clone https://github.com/"
alias xstart="sudo xampp start apache"
alias xstop="sudo xampp stop apache"
